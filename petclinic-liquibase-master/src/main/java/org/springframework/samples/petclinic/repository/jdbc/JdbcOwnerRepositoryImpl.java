...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
	...
	public void loadPetsAndVisits(final Owner owner) {
		...
		final List<JdbcPet> pets = this.namedParameterJdbcTemplate.query(
				...
				params, new JdbcPetVisitExtractor());
	...
	public void save(Owner owner) throws DataAccessException, Exception {
		...
		try {
			...
			throw new Exception("You are trying to enter null value in NOT NULL column 'City'");
		}
	}
	 ...
	 *
	 * @param owners
	 *            the list of owners for whom the pet and visit data should be
	 *            loaded
